...
.DEFAULT_GOAL := all
isort = isort taulukko tests
black = black -S -l 120 --target-version py38 taulukko tests
...
.PHONY: test
test: clean
	pytest --cov=taulukko --log-format="%(levelname)s %(message)s"
